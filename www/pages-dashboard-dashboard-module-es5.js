      ...
      var DashboardPage = /*#__PURE__*/function () {
        ...
        _createClass(DashboardPage, [{
          ...
          value: function ionViewDidEnter() {
            ...
            this.platform.isLandscape() ? this.view = [this.platform.width(), this.platform.height() * 0.69] : this.view = [this.platform.width(), this.platform.height() * 0.5];
            this.screenOrientation.onChange().subscribe(function (r) {
              _this.platform.isPortrait() ? _this.view = [r.path[0].innerHeight, r.path[0].innerWidth * 0.69] : _this.view = [r.path[0].innerHeight, r.path[0].innerWidth * 0.5];
            });
            ...
            this.userService.getFundsChart().subscribe(function (r) {
