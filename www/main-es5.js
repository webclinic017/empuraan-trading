  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
      ...
      var MarubozuService = /*#__PURE__*/function () {
        ...
        _createClass(MarubozuService, [{
          ...
          value: function get(key) {
            return this.http.get(this.apiUrl + key).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (payload) {
          ...
          value: function createWithBlob(title, content, stockname, key, blobData, name, ext) {
            ...
            console.log("".concat(this.apiUrl).concat(key));
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(platform, splashScreen, statusBar, alertController, location, router, userService, navCtrl, navParams) {
        ...
        _createClass(AppComponent, [{
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      ...
                      this.backButtonEvent(); // this.tabBarElement = document.querySelector('.tabbar');
                      // this.tabBarElement.style.display = 'none';

                      setTimeout(function () {
                        _this12.splash = false; // this.tabBarElement.style.display = 'flex';
                      }, 4000);
          ...
          value: function backButtonEvent() {
            ...
            this.platform.backButton.subscribeWithPriority(10, function () {
              if (_this14.router.url == "/home/dashboard") _this14.backButtonAlert();else _this14.location.back();
            });
          }
        }, {
          key: "backButtonAlert",
          ...
          value: function initializeApp() {
            ...
            this.platform.ready().then(function () {
              _this15.statusBar.styleDefault();

              _this15.splashScreen.hide();

              _this15.userService.authenticated.subscribe(function (a) {
                a ? _this15.router.navigate(['home', 'dashboard']) : _this15.router.navigate(['home', 'login']);
          ...
          value: function codeCheck(email, code) {
            ...
            if (typeof code != "undefined" && code) {
              this.userService.checkCodeValid(email, code).subscribe(function (r) {
                _this16.openChangePasswordModal(email);

                _this16.dismissModal();

                _this16.spinner = false;
              }, function () {
                _this16.presentErrorToast("Code is incorrect.");
        ...
        _createClass(BuySellModalPopupComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.stockService.listen("".concat(this.selectedStock.id, "-").concat(this.selectedWatchlistId)).subscribe(function (res) {
              _this17.selectedStock.ltp = res[0].close;
            });
          }
        }, {
          key: "dismissModal",
            ...
            if (email != '') {
              if (this.checkIfEmailInString(email)) {
                this.userService.emailExists(this.email).subscribe(function (r) {
                  ...
                  _this18.dismissModal();

                  _this18.openCodeCheckModal(email);
                }, function () {
                  _this18.spinner = false;

                  _this18.presentErrorToast('Email does not exist.');
                });
              } else {
                this.spinner = false;
        ...
        _createClass(UserService, [{
          ...
          value: function logIn(input) {
            ...
            return this.http.post(this.apiUrl + "login", input).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (res) {
              ...
              _this20.authenticate(user, res.jwt);

              _this20.decodedToken = _this20.decodeToken(res.jwt);
          ...
          value: function checkToken() {
            ...
            return this.storage.get("token").then(function (r) {
              if (r) {
                _this22.authenticated.next(r);

                _this22.user.next(r.user);
              }
            });
          }
        }, {
          ...
          value: function logout() {
            ...
            return this.storage.remove("token").then(function (r) {
              return _this23.authenticated.next(false);
            });
          }
        }, {
          key: "add",
          ...
          key: "getPlatformOfUser",
          value: function getPlatformOfUser() {
        ...
        _createClass(ModalEditWatchlistsComponent, [{
          ...
          value: function getWatchlists() {
            ...
            this.userService.getSettings().subscribe(function (r) {
              ...
              if (datatype == "simulated") _this24.watchlistService.getSimulatedWatchlists().subscribe(function (r) {
                console.log("simulated", r);
                _this24.dataLoaded = true;
              });
              if (datatype == "realtime") _this24.watchlistService.getRealtimeWatchlists().subscribe(function (r) {
                console.log("realtime", r);
                _this24.watchlists = r.data;
                _this24.dataLoaded = true;
              });
            });
          }
          ...
          value: function onCreateWatchlist() {
            ...
            if (((_a = this.watchlistName) === null || _a === void 0 ? void 0 : _a.trim()) != "" && this.watchlistName != null && this.watchlistName != undefined) {
              ...
              this.watchlistService.createWatchlist(this.watchlistName).subscribe(function () {
                _this25.changeInWatchlist = true;
                _this25.spinner = false;

                _this25.presentSuccessToast("\"".concat(_this25.watchlistName, "\" was successfuly created."));

                _this25.watchlistName = "";

                _this25.getWatchlists();
              });
            } else this.presentErrorToast("Input field is empty.");
          }
        }, {
          ...
          value: function changePosition() {
            ...
            this.watchlistService.updateWatchlistPositions(positions).subscribe(function () {
              return _this26.changeInWatchlist = true;
            });
          }
        }, {
          key: "presentErrorToast",
                  ...
                  switch (_context16.prev = _context16.next) {
                    case 0:
                      buttons = [{
                        ...
                        icon: "image",
                        handler: function handler() {
                          _this28.addImage(_capacitor_core__WEBPACK_IMPORTED_MODULE_6__["CameraSource"].Photos);
                        }
                      }];
                      ...
                      if (!this.plt.is("hybrid")) {
                        buttons.push({
                          ...
                          icon: "attach",
                          handler: function handler() {
                            _this28.fileInput.nativeElement.click();
                          }
                        });
                      }
            ...
            if (postForm.valid) {
              ...
              if (image == undefined || image == null) {
                this.api.createWithBlob(title, content, stockName, key).subscribe(function () {
                  _this29.dismissModal(true);

                  _this29.spinner = false;
                }, function () {
                  _this29.presentErrorToast('Something went wrong.');
