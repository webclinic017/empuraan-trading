...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BTC_PRICE_LIST", function() { return BTC_PRICE_LIST; });
...
/* harmony import */ var src_app_services_chart_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/chart.service */ "tC2j");
...
let ChartPage = class ChartPage {
    constructor(chartService, route, userService) {
    ...
    drawTv() {
        ...
        this.tradingview = new window.TradingView.widget({
            ...
            datafeed: {
                onReady(x) {
                    Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["timer"])(1e3)
                ...
                getBars(symbol, granularity, startTime, endTime, onResult, onError, isFirst) {
                    ...
                    const instance = axios__WEBPACK_IMPORTED_MODULE_6___default.a.create({
...
/* harmony import */ var _shared_chart_mock_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/chart-mock-data */ "6fw9");
...
let ChartService = ChartService_1 = class ChartService {
    ...
    static dataGenerator(time = +new Date()) {
        const obj = {};
        Object.assign(obj, _shared_chart_mock_data__WEBPACK_IMPORTED_MODULE_4__["BTC_PRICE_LIST"][this.dataIndex], { time });
    ...
    getHistoryList(param) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"]((ob) => {
            ob.next(list);
            ob.complete();
        });
    }
    ...
    fakeWebSocket() {
        ...
        const sendData = () => {
            const duration = 1e3;
            subscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(duration)
                ...
                return ChartService_1.dataGenerator(this.lastBarTimestamp);
            }))
                .subscribe(x => {
...
ChartService.dataTemplate = { 'time': 1545572340000, 'open': 3917, 'high': 3917, 'low': 3912.03, 'close': 3912.62, 'volume': 3896 };
...
ChartService = ChartService_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
