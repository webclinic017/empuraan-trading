(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-orders-orders-module"], {
    ...
    function EpG(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_modals_modal_edit_order_modal_edit_order_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/modals/modal-edit-order/modal-edit-order.component */
      "LX2U");

      var OrdersPage = /*#__PURE__*/function () {
        function OrdersPage(orderService, route, modalCtrl, actionSheetController) {
        ...
        _createClass(OrdersPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.totalPandL = this.orderService.totalPandL(); // this.route.queryParams.subscribe(q => {
            //   // selectTab(q.selectTab)
            // })
          }
        }, {
          key: "tabIndex",
          value: function tabIndex(ev) {
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            if (_this.pageIndex == 0) _this.openModalEditOrderPosition(order);else if (_this.pageIndex == 2) _this.openModalEditOrderPending(order);
                          }
                        }, {
                          text: 'Cancel',
                          icon: 'close',
