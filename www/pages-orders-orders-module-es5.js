(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-orders-orders-module"], {
    ...
    function EpG(module, __webpack_exports__, __webpack_require__) {
      ...
      var OrdersPage = /*#__PURE__*/function () {
        ...
        _createClass(OrdersPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.orderService.getAllUserOrders().subscribe(function (res) {
              res.data.forEach(function (o) {
                _this.stockService.getStock(o.stockId).subscribe(function (s) {
                  o.stockName = s.data.companyName;
                });

                switch (o.status) {
                  case 'positioned':
                    _this.position.push(o);

                    _this.checkIfOrderIsCompleted(o);

                    break;

                  case 'completed':
                    _this.completed.push(o);

                    break;

                  case 'pending':
                    _this.pending.push(o);
          ...
          key: "checkIfOrderIsCompleted",
          value: function checkIfOrderIsCompleted(complete) {
            ...
            if (complete.transactionTwo.status == "pending") {
              if (complete.stoploss) {
                var order = Object.assign({}, complete);
                order['isStopLoss'] = true;
                this.pending.push(order);
              }

              if (complete.target) {
                var _order = Object.assign({}, complete);

                _order['isStopLoss'] = false;
                this.pending.push(_order);
              }
            }
          }
        }, {
    ...
    function F6Pd(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".logo {\n  height: 70px;\n  width: 70px;\n  padding-right: 10px;\n}\n\nion-title {\n  color: black;\n}\n\n.skeleton-row {\n  width: 100%;\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n}\n\nsuper-tab-button {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n}\n\n.success {\n  color: #7fd300;\n  font-weight: 500;\n}\n\n.failure {\n  color: #d20000;\n  font-weight: 500;\n}\n\ntable p {\n  padding-bottom: 0;\n  margin-bottom: 0%;\n  padding-left: 10px;\n}\n\n.column-centralise-text {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: flex-end;\n}\n\nion-card ion-card-content {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\nion-list {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n\nion-list ion-grid {\n  padding-right: 0;\n}\n\nion-list ion-grid ion-col {\n  padding-right: 0;\n}\n\nion-item .success {\n  color: #7fd300;\n  font-weight: 500;\n}\n\nion-item .failure {\n  color: #d20000;\n  font-weight: 500;\n}\n\nion-item p {\n  font-size: 13px;\n}\n\nion-item span {\n  color: #747474;\n}\n\nion-item .sell {\n  background-color: #ffa8a880;\n  color: #ff0000;\n  padding: 3px 12px;\n  border-radius: 5px;\n}\n\nion-item .buy {\n  background-color: #7474ff80;\n  color: #0008ff;\n  padding: 3px 12px;\n  border-radius: 5px;\n}\n\nion-item .cancelled {\n  background-color: #e3e3e380;\n  color: #4b4b4b;\n  padding: 3px 12px;\n  border-radius: 5px;\n}\n\nion-item .complete {\n  background-color: #4dff4d80;\n  color: #078f00;\n  padding: 3px 12px;\n  border-radius: 5px;\n}\n\nion-item .padding-hor {\n  padding: 0 7px;\n}\n\nion-item .padding-strt {\n  padding-left: 7px;\n}\n\n@media (prefers-color-scheme: dark) {\n  ion-item span {\n    color: #949494;\n  }\n  ion-item .sell {\n    background-color: #ff747459;\n    color: #ffaaaa;\n  }\n  ion-item .buy {\n    background-color: #7474ff59;\n    color: #aaadff;\n  }\n  ion-item .cancelled {\n    background-color: #6a6a6a80;\n    color: #ffffff;\n  }\n  ion-item .complete {\n    background-color: #1fe41f80;\n    color: #4dff43;\n  }\n}\n\n@media screen and (max-width: 360px) {\n  ion-title {\n    font-size: 14px !important;\n  }\n\n  ion-label, h3, p {\n    font-size: 12px !important;\n  }\n\n  ion-card-subtitle {\n    font-size: 12px !important;\n  }\n\n  ion-card-title {\n    font-size: 13px !important;\n  }\n\n  ion-searchbar {\n    font-size: 12px !important;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
