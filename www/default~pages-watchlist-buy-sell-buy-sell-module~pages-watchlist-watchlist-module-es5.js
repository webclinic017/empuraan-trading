  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-watchlist-buy-sell-buy-sell-module~pages-watchlist-watchlist-module"], {
    ...
    function aY2Y(module, __webpack_exports__, __webpack_require__) {
      ...
      var BuySellPage = /*#__PURE__*/function () {
        function BuySellPage(route, watchlistService, orderService, router) {
        ...
        _createClass(BuySellPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.queryParams.subscribe(function (data) {
              data.isBuy == 'true' ? _this.isBuy = true : _this.isBuy = false;
            });
            this.route.params.subscribe(function (data) {
              return _this.company = _this.watchlistService.getCompany(data["id"]);
            });
          }
        }, {
          ...
          value: function onSubmit() {
            ...
            if (quantity != '' && order != '' && price != '' && quantity > 0) {
              if (order != 'market' && price > 0) {
                console.log({
                  formVal: this.buySellForm.value
                });
...
//# sourceMappingURL=default~pages-watchlist-buy-sell-buy-sell-module~pages-watchlist-watchlist-module-es5.js.map